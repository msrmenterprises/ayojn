...
@section('content')
    ...
    <!-- /.box-header -->
        ...
        <form role="form" method="POST" name="editsubuser" id="editsubuser" action="{{ route('vouch-update') }}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="vouch_code" name="vouch_code"
                                   placeholder="Enter Vouch Code" value="{{ $vouchCode->vouch_code }}">
                                <input type="hidden" name="code_id" value="{{ $vouchCode->id }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="vouch_amount" name="vouch_amount"
                                   placeholder="Enter Vouch Amount" value="{{ $vouchCode->vouch_amount }}">
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-info pull-left" id="adduserbutton" name="adduserbutton">Update Vouch code<i class="fa fa-refresh fa-spin upload_spin" style="display: none"></i></button>
            </div>
        </form>
    </div>
    <script>
