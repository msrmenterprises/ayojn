...
@section('content')
    ...
    <section id="feed" class="speakers" >
        <div class="container">
            ...
            <!-- <h2 class="text-center">Thank you for sharing your inputs.<br> While we validate the details how about you have a read on how we are building a momentum for Sponsorr.</h2> -->
                {{--    <h2 class="text-center">Thank you for sharing your inputs.<br> While we validate the details how about you recommend Sponsorr to a few colleagues/peers who could use it and you may access Sponsorr for the next 12 months.</h2>--}}

                <h2 class="text-center"><br/><br/><br/>Sorry, This Collaboration is no longer available</h2>
                <hr>
