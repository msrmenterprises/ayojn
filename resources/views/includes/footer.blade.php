...
<footer
    class="flw footer-main {{ (request()->path() == '/' || request()->path() == 'expertise' || request()->path() == 'connect' || ! empty(Auth::user()) ) ? 'fixed-footer' : '' }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="pull-left">
                    ...
                    <div class="smofooter">
                        ...
                        <a href="https://www.quora.com/profile/Ayojn" target="_blank">
                            <i class="fa fa-quora"></i></a>
                        <a href="https://www.facebook.com/Ayojn" target="_blank">
                            <i class="fa  fa-facebook"></i></a>
                        <a href="https://www.linkedin.com/company/Ayojn" target="_blank">
                            <i class="fa  fa-linkedin"></i></a>
                        <a href="https://medium.com/@Ayojn" target="_blank">
