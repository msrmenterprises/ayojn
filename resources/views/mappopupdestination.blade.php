						...
						@foreach($contry_userData as $country_data)
							...
							<div class="col-md-12 col-lg-12 align-self-center">
								<p class="text-muted font-13 mb-1">
									<i class="mdi mdi-checkbox-blank-circle mr-2 text-success"></i>{{ $country_data->sponsor_counties->country_name.' (based on '.$country_data->user_count.' inputs)' }}   <span class="float-right">  </span>
								</p>
								<div class="progress" >
