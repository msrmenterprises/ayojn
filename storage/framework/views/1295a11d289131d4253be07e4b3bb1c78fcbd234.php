	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
				...
				<span style="text-align: center; display: block; color: red;">Your will Get <?php if($bids['per']==0): ?> 10% <?php else: ?> <?php echo e($bids['per']); ?>% <?php endif; ?> in your wallet </span>
			...
			<div class="form-group autocomplete" style="width: 100%; display: block; margin-left: auto; margin-bottom:10px; margin-right: 0;">
						...
						<?php echo e($bids['sponsor_budget']); ?>
...
<script type="text/javascript">
	...
	$(document).on('click', '.paynowfinal', function (e) {
		...
		if($(".final").val()=="")
		{
			alert('Close Amount is required!');
			$(".final").focus();
			return false;
			e.preventDefault();
		}
