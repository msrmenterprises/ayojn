                    ...
                    <?php if(!empty($orders)): ?>
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><b>Partner:</b> <?php echo e($order->offerred_by); ?>, <br/><b>Offer for:</b> <?php echo e($order->offer_for); ?>,<br/> <b>Deal Amount:</b><?php echo e($order->deal_amount); ?>,</td>
                                <td><?php echo e($order->entity); ?> -<?php echo e($order->identity); ?>

                                    <br/>
                               
                                    <?php if($order->sponsor_type==1): ?>
                                    <b>Type:</b> Offer user 
                                    <?php elseif($order->sponsor_type==2): ?>
                                ...
                                <td><?php echo e($order->final_amt); ?></td>
                                ...
                                <td>
                                    ...
                                    <b>Date:</b> <?php echo e($order->appove_date); ?><br/>
                                    <b>Remark:</b> <?php echo e($order->payment_remark); ?>
                                ...
                                <td>
                                   <?php if($order->status==3): ?>
                                    ...
                                    <?php elseif($order->status==4): ?>
                                        ...
                                        <a class="btn btn-danger query_button btn-sm" title="query"><i class="fa fa-question-circle"></i></a>
                                        <a data-id="<?php echo e($order->id); ?>" class="btn btn-success feedback_button btn-sm" title="Feedback"><i class="fa fa-comments"></i></a>
                                        <a data-id="<?php echo e($order->id); ?>" class="btn btn-primary payment btn-sm" title="Payment"><i class="fa fa-inr"></i></a>
  ...
  <div class="marvel-device nexus5">
    ...
    <script>
        ...
        $('#payment_modal').on('submit', function(event){
            ...
            $.ajax({
                url:'<?php echo e(route("store-payment")); ?>',
                method:'post',
        ...
        $(document).on('click', '.feedback_button', function (e) {
            ...
            var id = $(this).attr('data-id');
            var url = "<?php echo e(route('show-feedback')); ?>";
            $.ajax({
                url: url,
                method: "POST",
                data: {id: id},
