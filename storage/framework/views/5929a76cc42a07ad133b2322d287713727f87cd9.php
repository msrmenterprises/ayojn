...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.box-header -->
        ...
        <form role="form" method="POST" name="editsubuser" id="editsubuser" action="<?php echo e(route('vouch-add')); ?>"
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-info pull-right" id="adduserbutton" name="adduserbutton">Add Vouch code<i class="fa fa-refresh fa-spin upload_spin" style="display: none"></i></button>
            </div>
        </form>
    </div>
    <script>
