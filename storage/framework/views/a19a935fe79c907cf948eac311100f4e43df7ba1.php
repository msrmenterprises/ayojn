                    ...
                    <div class="col-md-6 ">
                        <div class="panel panel-login">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form id="login-form" action="<?php echo e(url("partner/login")); ?>" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="text-center">
                                                            <a href="<?php echo e(url('/password/reset')); ?>" tabindex="5"
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="text-center">
                                                            <a href="<?php echo e(url('/username/reset')); ?>" tabindex="5"
                                        ...
                                        <form id="register-form" action="<?php echo e(url('partner/register')); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="terms"> I am OK to receive further communication from Sponsay and acknowledge the <a href="javascript: privacyWindow()">privacy policy.</a>
                                                    <!--<a
