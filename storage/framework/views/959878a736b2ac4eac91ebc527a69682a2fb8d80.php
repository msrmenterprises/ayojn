...
<?php $__env->startSection('content'); ?>
	...
	<section class="content">
		<div class="row">
			...
			<div class="col-md-12">
                ...
                <th width="10%">Bid Book/Pay Status</th>
	...
	<script type="text/javascript">
      ...
      $(function () {
        var url = "<?php echo e(url('controlpanel/list-bid')); ?>";
      ...
      function deleteUser(id) {
        swal({
          ...
          if (result.value) {
            var url = "<?php echo e(route('delete-bid')); ?>";
            $('#spinner').show();
            $.ajax({
              url: url,
              method: "POST",
      ...
      function changeStatus(id) {
        ...
        swal({
          ...
          if (result.value) {
            var url = "<?php echo e(route('bid-change-status')); ?>";
            $('#spinner').show();
            $.ajax({
              url: url,
              method: "POST",
