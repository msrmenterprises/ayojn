		...
		<div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
			...
			<div id="wallet_row" class="form-group autocomplete" style="width: 100%; display: block; margin-left: auto; margin-bottom:10px; margin-right: 0;">
                ...
                <input type="checkbox" value="" class="click_wallet form-control" style="height: 16px; width: 16px; margin-top: 3px; position: absolute;" />
            ...
            <div id="voucher_row" class="form-group autocomplete" style="width: 100%; display: block; margin-left: auto; margin-bottom:10px; margin-right: 0;">
                <label>
                <input type="checkbox" value="" class="click_voucher form-control" style="height: 16px; width: 16px; margin-top: 3px; position: absolute;" />
...
$(".click_voucher").click(function(){
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if(data > 0){
                                        ...
                                        swal("Warning", "voucher not exist", "warning");
                                    }
    ...
    $(document).on('click', '.paynowfinal', function (e) {
        ...
        $.ajax({
                ...
                type: 'POST',
                data: {_token: CSRF_TOKEN, vid: vid, wallet:wallet, amt: amt, voucher_code: voucher_code},
                headers: {
                'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
            },
                success: function (data) {
