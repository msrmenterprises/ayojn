                            ...
                            <?php endif; ?>
                                ...
                                <td>
                                    <a href="javascript:void(0)"
                                       ...
                                       data-value="<?php echo e($response->id); ?>">Read More&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></a> 
                                     <?php if($response->is_accepted == 1): ?>

                                     <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="acceptBid(<?php echo e($response->id); ?>,'2')"
                                           title="Open for Negotiation">Open for Negotiation&nbsp;<i class="fa fa-check"
                                                                                                     aria-hidden="true"></i></a>

                                    <?php elseif($response->is_accepted == 2): ?>
                                    <a href="javascript:void(0)" class="btn btn-success btn-sm bookNegotiation" onclick="acceptBid(<?php echo e($response->id); ?>,'3')">
                                        <i class="fa fa-hand-o-up"></i> Book Now</a>
                                    <?php elseif($response->is_accepted == 3): ?>
                                    <!--a href="javascript:void(0)" class="btn btn-danger btn-sm paynow btn-xs" data-bid="<?php echo e($response->id); ?>">Pay Now</a-->

                                    <a href='javascript:void(0)' class='btn btn-success button-success-color paynow_modal btn-xs' data-bid='<?php echo e($response->id); ?>'> Pay Now</a>
...
<div class="modal" id="paynow_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-sm" role="document" style="width:450px;">
		<div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                Your will Get <?php if($rst->per==0): ?> 10% <?php else: ?> <?php echo e($rst->per); ?>% <?php endif; ?> in your wallet
                </span>
			</div>
    ...
    <script>
        ...
        $.ajax({
                url: "<?php echo e(route('paynow-page-user')); ?>",
                type: 'POST',
        ...
        $(".click_wallet").click(function(){
            ...
            if(check) 
            {
                ...
                if(<?php echo e(auth::user()->wallet_balance); ?> > closeamt)
                {
            ...
            else
            {
                ...
                if(<?php echo e(auth::user()->wallet_balance); ?> > chk)
                {
                    $("#paidamt").html(chk);
                }
                else{
