...
<?php $__env->startSection('content'); ?>
	...
	<script type="text/javascript">
      ...
      $(function () {
        var url = "<?php echo e(url('controlpanel/list-response')); ?>" + "/<?php echo e(request()->segment(count(request()->segments()))); ?>";
      ...
      $('#data-table tbody').on('change', 'input[type="checkbox"]', function () {
       ...
       $(document).on('click', '.paynow', function (e) {
        ...
        swal({
          title: "Are you sure?",
          text: "Are you sure that you want to Pay?",
          icon: "warning",
          buttons: true,
          dangerMode: true
        }).then(
          function (isConfirm) {
            if (isConfirm) {
              $.ajax({
                url: "<?php echo e(route('paynow-page')); ?>",
                type: 'POST',
                ...
                success: function (data) {
                 ...
                 // oTable.draw();
                  swal("Payment Updated", "Payment has been Updated successfully.", "success");
                },
                error: function () {
                  // Show an alert with the result

                  swal("Payment Not Updated", "There's been an error. Your Payment might not have been Updated.", "error");
                }
              });
            }
          });
