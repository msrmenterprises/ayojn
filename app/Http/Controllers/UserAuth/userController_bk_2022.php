...
class userController extends Controller
{
    ...
    public function sendUsername(Request $request)
    {
        ...
        if ($userData) {
            ...
            return redirect()->back()->with('message', 'Mobile number or Hint answer does not match with any record. You can either start fresh with a new sign-up or have a chat with us to help you recover your old account.');
        }
    }
